 ...
 *
 * TODO: make this look more like PlayerControllerHuman
 * in that for each decision, this package handles game rules/valid combinations
 * and the brains handles all actual decision-making
 *
 * Handles phase skips for now.
 */
public class PlayerControllerAlpha_old extends PlayerController {
    private final AlphaController brains;

    // private boolean pilotsNonAggroDeck = false;

    public PlayerControllerAlpha_old(Game game, Player p, LobbyPlayer lp) {
        super(game, p, lp);
